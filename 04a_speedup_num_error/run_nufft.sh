...
# High Water Mark
DEBUG_LEVEL=4 /usr/bin/time -v bart nufft $FLAGS -i $TMP_DIR/traj_ga_rb $TMP_DIR/k_ga_rb $TMP_DIR/reco_ga &> data
...
DEBUG_LEVEL=4 /usr/bin/time -v bart nufft $FLAGS -i $TMP_DIR/traj_raga_rb $TMP_DIR/k_raga_rb $TMP_DIR/_reco_raga &> data
...
bart nufft -i $FLAGS -g $TMP_DIR/traj_ga_rb $TMP_DIR/k_ga_rb $TMP_DIR/reco_ga
...
bart nufft -g $FLAGS -i $TMP_DIR/traj_raga_rb $TMP_DIR/k_raga_rb $TMP_DIR/_reco_raga
