...
python3 plot_map.py 2 0 t1_raga bin/t1_raga '$T_1$ map / s'
...
inkscape binning_canvas.svg --export-background=white --export-filename=figure_B.pdf
inkscape binning_canvas.svg --export-background=white --export-filename=figure_B.eps
...
rm figure_A.svg figure_B.pdf figure_C.svg
